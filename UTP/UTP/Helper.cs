...
namespace UTP
{
    public class Helper
    {
        ...
        //Mega Dropdown
        public static string MDQuery { get { return @"<View><Query><Where><Eq><FieldRef Name='Active' /><Value Type='Boolean'>1</Value></Eq></Where><OrderBy><FieldRef Name='Category_x003a_Section' Ascending='True' /></OrderBy></Query><ViewFields><FieldRef Name='URL' /><FieldRef Name='Category' /><FieldRef Name='Category_x003a_Section' /></ViewFields><QueryOptions /></View>"; } }
        ...
        //QuickLink Button
        public static string QBQuery { get { return @"<OrderBy><FieldRef Name='URL' Ascending='True' /></OrderBy>"; } }
