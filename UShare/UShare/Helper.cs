...
namespace UShare
{
    public class Helper
    {
        ...
        public static string UPQuery { get { string today = SPUtility.CreateISO8601DateTimeFromSystemDateTime(DateTime.Now); return $"<Where><Geq><FieldRef Name='EndDate' /><Value IncludeTimeValue='TRUE' Type='DateTime'>{today}</Value></Geq></Where><OrderBy><FieldRef Name='EventDate' Ascending='True' /></OrderBy>"; } }
        public static string UPTitleField { get { return "Title"; } }
        public static string UPExpiresField { get { return "EventDate"; } }
        public static string UPBodyField { get { return "Description"; } }

        //The Latest
        public static string TLQuery { get { /*string today = SPUtility.CreateISO8601DateTimeFromSystemDateTime(DateTime.Now);*/ return $"<OrderBy><FieldRef Name='Created' Ascending='False' /></OrderBy>"; } }
        ...
        public static string NoImageURL { get { return SPContext.Current.Web.Url + "/SiteAssets/No_Image_Available.png"; } }
