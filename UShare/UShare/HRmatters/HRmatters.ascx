...
<section class="sec-news">
	<section class="sec-hrmatters-title"><asp:Label runat="server" ID="WPTitle"></asp:Label></section>
	<section class="sec-hrmatters-subTitle">
		<p><asp:Label runat="server" ID="WPSubTitle"></asp:Label></p>
	</section>
	<asp:Literal runat="server" ID="ltrTheLatest"></asp:Literal>
    <asp:Literal runat="server" ID="btnMore"></asp:Literal>
</section>