...
<section class="sec-hse-detail">
    <section class="sec-hse-detail-title">Health & Safety Environment Detail</section>
    <section class="sec-hse-detail-row">
        ...
        <section class="sec-hse-detail-date"><i class="far fa-calendar-alt"></i><asp:Literal runat="server" ID="Date"></asp:Literal></section>
